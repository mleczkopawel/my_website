  ...
  <body>  
   <?php
        include 'layout/menu.php';  
                ...
                {    
                    echo "<b><h1>Cześć, ".$_SESSION['user2']."!</h1></b><br>";
                    include 'sesje.inc';
                }
                else
                {
                    if (!isset($_POST['login2']) && !isset($_POST['password2']) && $_SESSION['auth2'] == FALSE)
                    {                    
            ?>
      <br><br><br><br><br>
            <div class='c'>
            ...
            <form class="formek" action="mysql/login.php" method="GET" name="login">
              <fieldset class="field">            
                ...
                <form action="mysql/login.php" method="GET" name="logowanie">
                    ...
                    <label> Hasło: </label><input name="password2" type="password" ><br>
