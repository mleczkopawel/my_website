<?php
                        ...
                        {           
                                ...
                                echo '<form class="c" method="GET">';
                                    echo '<input type="hidden" name="baza" value="'.$baza.'"></input><input type="hidden" class="show" name="tabela" value="'.$tabela.'"></input><input type="submit" name="ilew" value="5"></input>';
                                    echo '<input type="hidden" name="baza" value="'.$baza.'"></input><input type="hidden" class="show" name="tabela" value="'.$tabela.'"></input><input type="submit" name="ilew" value="10"></input>';
                                    echo '<input type="hidden" name="baza" value="'.$baza.'"></input><input type="hidden" class="show" name="tabela" value="'.$tabela.'"></input><input type="submit" name="ilew" value="15"></input>';
                                    echo '<input type="hidden" name="baza" value="'.$baza.'"></input><input type="hidden" class="show" name="tabela" value="'.$tabela.'"></input><input type="submit" name="ilew" value="20"></input>';
                                    echo '<input type="hidden" name="baza" value="'.$baza.'"></input><input type="hidden" class="show" name="tabela" value="'.$tabela.'"></input><input type="submit" name="ilew" value="25"></input>';
                                    echo '<input type="hidden" name="baza" value="'.$baza.'"></input><input type="hidden" class="show" name="tabela" value="'.$tabela.'"></input><input type="submit" name="ilew" value="50"></input>';
                                    echo '<input type="hidden" name="baza" value="'.$baza.'"></input><input type="hidden" class="show" name="tabela" value="'.$tabela.'"></input><input type="submit" name="ilew" value="100"></input>';
                                echo '</form>';
                                if(!isset($_GET['ilew']))
                                {
                                    $onpage=20;
